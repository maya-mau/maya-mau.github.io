...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Some cool projects I&#39;ve worked on over the years.",
          section: "Navigation",
          handler: () => {
          ...
          title: "repositories",
          description: "Explore my github repositories and contributions here.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-successfully-defended-my-thesis-thank-you-to-my-committee-and-advisors",
          title: 'Successfully defended my thesis! Thank you to my committee and advisors.',
          description: "",
          section: "News",},{id: "projects-molvisweb",
          title: 'MolVisWeb',
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%6D%31%32%34@%77%65%6C%6C%65%73%6C%65%79.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/maya-mau", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/maya-mau", "_blank");
        },
      },{
      id: 'light-theme',
